...
public abstract class Commander {
    ...
    public Result appSelect(String... args) {
        return execCommand(getMethodName(), args);
    }
     ...
     * limitations
     * of a real user, like not being able to     * type into a invisible or read only elements. This is useful for dynamic UI widgets (like auto-completing
