 ...
 * @author lian.shen
 */
public class AppStoreCheckboxState extends AbstractCommand {
    private static final int ARG_LOCATOR = 0;
    private static final int ARG_VALUE = 1;

    private final Logger log = LoggerFactory.getLogger(this.getClass());

    public AppStoreCheckboxState(int index, String name, String... args) {
    ...
    protected Result executeImpl(Context context, String[] curArgs) {
        ...
        String result = element.getAttribute("checked");
        context.getVarsMap().put(value, result);
